...
mod tests {
    ...
    #[test]
    fn test_new() {
        let result = HitRecord::new(Vec3::new(1.0, 2.0, 3.0), Vec3::new(2.0, 0.0, 0.0), 0.0, true);
    ...
    #[test]
    fn test_set_p() {
        let mut result = HitRecord::new(Vec3::new(1.0, 2.0, 3.0), Vec3::new(2.0, 0.0, 0.0), 0.0, true);
        equality(&result.p(), 1.0, 2.0, 3.0);
